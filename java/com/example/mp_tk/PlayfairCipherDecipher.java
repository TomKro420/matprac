...
public class PlayfairCipherDecipher {
    static char [] decrypt(String encpt, String key) {
        ...
        System.out.print("\n\ntext po rozšyfrovaní: ");
        for (int i = 0; i < decpt_arr_ctr; i++) System.out.print(decpt_arr[i]);
        return decpt_arr;
    }
    ...
    public static void main(String[] args) {
        String encpt;
        System.out.print("zadej zašifrovanej text: ");
        Scanner scanner = new Scanner(System.in);
        encpt = scanner.nextLine();
        String key;
        System.out.print("klíč k rozšyfrovaní: ");
